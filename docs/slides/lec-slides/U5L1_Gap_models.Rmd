...
.pull-right-wide-left[![](img/U5/barra_arbol.png)]
...
.pull-extleft-right[![](img/U5/growth.png)]
.pull-left[
where:
* $D$ is diameter
...
.font90[* The only resource for which there is explicit competition is light
...
.pull-extleft-right[![](img/U5/mortality.png)]
...
.pull-right[
.bottom2[![](img/U5/foret_poster.png)
